    ...
    <div class="content has-text-centered" id="flow">    
      ...
      <article class="message is-info is-small">
        <div class="message-body">
          <p>Check the "fromdomain" in the Splunk log. Advise the customer to update the domain they are sending from to one that is attached to the hosting account.</p>
        </div>
      </article>
