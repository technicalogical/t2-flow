    ...
    <div class="content has-text-centered" id="flow">    
      ...
      <article class="message is-info is-small">
        <div class="message-body">
         	Advise the customer on rekeying the certificate. They will need to select <strong>"Change the site your certificate protects"</strong> and select from the available domains in the dropdown or type it in the field. Advise on the SLA for completion of the rekey.
        </div>
      </article>
