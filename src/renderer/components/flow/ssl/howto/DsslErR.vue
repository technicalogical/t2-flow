    ...
    <div class="content has-text-centered" id="flow">    
      ...
      <article class="message is-info is-small">
        <div class="message-body">
         	Advise the customer on rekeying the certificate. They do not need to make any changes however they are the only one who can submit the rekey.
        </div>
      </article>
      <article class="message is-success is-small">
        <div class="message-body">
         			If this is a result from difficulty in setting up the <strong>DSSL</strong> offer <strong>ESSL ( Easy SSL)</strong>. We can handle 100% of the SSL needs.
        </div>
      </article>
