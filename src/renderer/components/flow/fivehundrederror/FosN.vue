<template>
  <div id="swat-deck">
    ...
    <div class="content has-text-centered" id="flow">
      ...
      <p>Enable debug mode to see what is causing the issue. Does this display an error in browser?</p>
      <p class="buttons">
          <router-link to="/flow/fivehundrederror/FosNo" class="button is-light">
            <span class="icon has-text-success">
              <i class="fas fa-check-circle"></i>
            </span>
            <span><b>Yes</b>. It displays errors.</span>
          </router-link>  
          <router-link to="/flow/fivehundrederror/FosNt" class="button is-light">
            <span class="icon has-text-danger">
              <i class="fas fa-exclamation-circle"></i>
            </span>
            <span><b>No</b>. It displays no errors.</span>
          </router-link>
        </p>
      </div> 
