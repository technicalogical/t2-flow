    ...
    <div class="content has-text-centered" id="flow">    
      ...
      <article class="message is-info is-small">
        <div class="message-body">
          		Advise the customer that the receiving Email provider is blocking emails from this address. They will need to reach out to that provider to troubleshoot from here.
        </div>
      </article>
