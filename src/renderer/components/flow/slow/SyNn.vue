<template>
  ...
  <div id="swat-deck">
    ...
    <div class="content has-text-centered" id="flow">
      ...
      <p class="buttons">
        <router-link to="/flow/slow/SyNnY" class="button is-light">
          <span class="icon has-text-success">
            <i class="fas fa-check-circle"></i>
          </span>
          <span><b>Yes.</b> I can duplicate the issue.</span>
        </router-link>  
        <router-link to="/flow/slow/SyNnN" class="button is-light">
          <span class="icon has-text-success">
            <i class="fas fa-check-circle"></i>
          </span>
          <span><b>No.</b> I can not duplicate this issue.</span>
        </router-link>
      </p>
