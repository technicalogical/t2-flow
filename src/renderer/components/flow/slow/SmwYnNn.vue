  ...
  <div id="swat-deck">
    ...
    <div class="content has-text-centered" id="flow">
      ...
      <div class="content is-medium">
        <p>Can you duplicate the slow site issue on <b>ClearSky</b>?</p>
      </div>

      <p class="buttons">
        <router-link to="/flow/slow/SmwYnNnY" class="button is-light">
          <span class="icon has-text-success">
            <i class="fas fa-check-circle"></i>
          </span>
          <span><b>Yes.</b> I can duplicate the issue.</span>
        </router-link>  
        <router-link to="/flow/slow/SmwYnNnN" class="button is-light">
