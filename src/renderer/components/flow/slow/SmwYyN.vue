<template>
  ...
  <div id="swat-deck">
    ...
    <div class="content has-text-centered" id="flow">
      ...
      <p class="buttons">
        <router-link to="/flow/slow/SmwYyNy" class="button is-light">
          <span class="icon has-text-success">
            <i class="fas fa-check-circle"></i>
          </span>
          <span><b>Yes.</b> The website performs better.</span>
        </router-link>  
        <router-link to="/flow/slow/SmwYyNn" class="button is-light">
          <span class="icon has-text-success">
            <i class="fas fa-check-circle"></i>
          </span>
      ...
      <!-- BEGIN - Back button -->
      <p class="buttons">
        <router-link to="/flow/slow/SmwYy" class="button is-small is-info">
