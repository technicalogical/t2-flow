    ...
    <div class="content has-text-centered" id="flow">    
      ...
      <article class="message is-info is-small">
        <div class="message-body">
          <p>Advise the customer of the standard expectation on migration timelines. They need to allow for the minimum timeframe to pass before we can address any concerns.</p>
        </div>
      </article>
      
      <!-- BEGIN - Back button -->
      <p class="buttons">
        <router-link to="/flow/migration/MigY" class="button is-small is-info">
