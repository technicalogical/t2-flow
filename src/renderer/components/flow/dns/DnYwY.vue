    ...
    <div class="content has-text-centered" id="flow">
      ...
      <article class="message is-info is-small">
        <div class="message-body is-small">
          <p>If there is an issue with the site it is most likely content related.</p>
        </div>
      </article>
      <article class="message is-success is-small">
        <div class="message-body is-small">
          <p>Consult on <b>WPPS</b> for <b>WordPress</b> based website.</p>
        </div>
      </article>

      <!-- BEGIN - Back button -->
      <p class="buttons">
        <router-link to="/flow/dns/DnYw" class="button is-small is-info">
