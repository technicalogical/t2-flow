    ...
    <div class="content has-text-centered" id="flow">    
      ...
      <article class="message is-info is-small">
        <div class="message-body">
          <p>Create a ticket in <strong>Sucuri HELP</strong> for that team to resolve this issue. Advise the customer of this action and the expected E.T.A. for completion.</p>
        </div>
      </article>
