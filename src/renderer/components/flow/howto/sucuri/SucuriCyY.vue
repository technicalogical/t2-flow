    ...
    <div class="content has-text-centered" id="flow">    
      ...
      <article class="message is-info is-small">
        <div class="message-body">
          <p>Advised the customer of the response to the ticket.</p>
        </div>
      </article>
      <article class="message is-info is-small">
        <div class="message-body">
          <p>If the ticket requests additional information transfer the call to a Tier 2 agent.</p>
        </div>
      </article>
      
      <!-- BEGIN - Back button -->
      <p class="buttons">
        <router-link to="/flow/howto/sucuri/SucuriCy" class="button is-small is-info">
