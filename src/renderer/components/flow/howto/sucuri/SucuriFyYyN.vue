    ...
    <div class="content has-text-centered" id="flow">    
      ...
      <article class="message is-info is-small">
        <div class="message-body">
          <p>Advise the customer of the  standard 12 (30min for express) completion time. They will need to allow for this timeframe to complete. We can address any issues that arise once that timeframe has expired.</p>
        </div>
      </article>
      
      <!-- BEGIN - Back button -->
      <p class="buttons">
        <router-link to="/flow/howto/sucuri/SucuriFyYy" class="button is-small is-info">
