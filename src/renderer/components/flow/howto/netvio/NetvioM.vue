  ...
  <div id="flow-deck">
    ...
    <div class="content has-text-centered" id="flow">
      <div class="content is-medium">
        <p>Which network violation is it?</p>
      </div>
      <p class="buttons">
        <router-link to="/flow/howto/netvio/NetvioMm" class="button is-light">
          <span class="icon has-text-success">
            <i class="fas fa-check-circle"></i>
          </span>
          <span>It is a <strong>Malware</strong> violation.</span>
        </router-link>  
        <router-link to="/flow/howto/netvio/NetvioMp" class="button is-light">
          <span class="icon has-text-success">
            <i class="fas fa-check-circle"></i>
          </span>
          <span>It is a <strong>Phishing</strong> violation.</span>
        </router-link>
      </p>
