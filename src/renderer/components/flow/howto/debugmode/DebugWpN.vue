    ...
    <div class="content has-text-centered" id="flow">    
      ...
      <article class="message is-info is-small">
        <div class="message-body">
          <p>The customer needs to create a new web.config file in order to enable debug mode. Send them this <a href="https://www.godaddy.com/help/what-is-a-webconfig-file-5445?" target="_blank"><strong>article</strong></a> to do so.</p>
        </div>
      </article>
      
      <!-- BEGIN - Back button -->
      <p class="buttons">
        <router-link to="/flow/howto/debugmode/DebugWp" class="button is-small is-info">
