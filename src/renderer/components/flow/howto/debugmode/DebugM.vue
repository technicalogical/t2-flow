    ...
    <div class="content has-text-centered" id="flow">    
      ...
      <article class="message is-info is-small">
        <div class="message-body">
          <p>Load <strong>wp-config.php</strong> file. Find debug mode option and change from "<strong>false</strong>" to "<strong>true</strong>". You will now be able to see the errors in the browser.</p>
        </div>
      </article>
