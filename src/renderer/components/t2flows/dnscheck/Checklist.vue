<template>
  ...
  <ul class="no-style">
    ...
    <div class="box">
    <p style="font-size: 10px">what affects propagation <a target="_blank" class="orange-link" href="https://www.godaddy.com/help/what-factors-affect-dns-propagation-time-1746"> here</a></p>
    </div>
