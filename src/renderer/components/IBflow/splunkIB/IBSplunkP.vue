    ...
    <div class="content has-text-centered" id="flow">    
      ...
      <article class="message is-info is-small">
        <div class="message-body">
          <p>Advise the customer that the Email is actively being blocked by the receiving email provider. Advise the customer to reach out to them to troubleshoot this issue.</p>
        </div>
      </article>
