...
// BEGIN Cron Job Test imported routes
import CronTest from '@/components/flow/cron/CronTest'
import CronY from '@/components/flow/cron/CronY'
import CronN from '@/components/flow/cron/CronN'
// END Cron Job Test imported routes
...
import cFirst from '@/components/flow/mig/closed/cFirst'
import cl from '@/components/flow/mig/closed/cl'
import cT from '@/components/flow/mig/closed/cT'
import clY from '@/components/flow/mig/closed/clY'
import clYw from '@/components/flow/mig/closed/clYw'
import clYwY from '@/components/flow/mig/closed/clYwY'
import clYwYy from '@/components/flow/mig/closed/clYwYy'
import clYwYn from '@/components/flow/mig/closed/clYwYn'
import clYwN from '@/components/flow/mig/closed/clYwN'
import clYn from '@/components/flow/mig/closed/clYn'
import clN from '@/components/flow/mig/closed/clN'
...
export default [
  ...
  //BEGIN - Cron Job Test Flow
  {
    path: '/flow/cron/CronTest',
    name: 'CronTest',
    component: CronTest,
  },
  {
    path: '/flow/cron/CronY',
    name: 'CronY',
    component: CronY,
  },
  {
    path: '/flow/cron/CronN',
    name: 'CronN',
    component: CronN,
  },
  //END - Cron Job Test Flow
  ...
  {
    path: '/flow/mwp/MigsyncMnY',
    name: 'MigsyncMnY',
    component: MigsyncMnY,
  },
  {
    path: '/flow/mwp/MigsyncMnN',
    name: 'MigsyncMnN',
    component: MigsyncMnN,
  },
  {
  ...
  {
    path: '/flow/mig/closed/cFirst',
    name: 'cFirst',
    component: cFirst
  },
  {
    path: '/flow/mig/closed/cl',
    name: 'cl',
    component: cl
  },
  {
    path: '/flow/mig/closed/cT',
    name: 'cT',
    component: cT
  },
  {
    path: '/flow/mig/closed/clY',
    name: 'clY',
    component: clY
  },
  {
    path: '/flow/mig/closed/clYw',
    name: 'clYw',
    component: clYw
  },
  {
    path: '/flow/mig/closed/clYwY',
    name: 'clYwY',
    component: clYwY
  },
  {
    path: '/flow/mig/closed/clYwYy',
    name: 'clYwYy',
    component: clYwYy
  },
  {
    path: '/flow/mig/closed/clYwYn',
    name: 'clYwYn',
    component: clYwYn
  },
  {
    path: '/flow/mig/closed/clYwN',
    name: 'clYwN',
    component: clYwN
  },
  {
    path: '/flow/mig/closed/clYn',
    name: 'clYn',
    component: clYn
  },
  {
    path: '/flow/mig/closed/clN',
    name: 'clN',
    component: clN
  },
  // END - Migration Flow
